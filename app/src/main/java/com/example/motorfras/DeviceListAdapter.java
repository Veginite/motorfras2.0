    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        itemHolder.linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                SharedPreferences.Editor editor = context.getSharedPreferences("hardwareAddress", 0).edit();
                editor.putString("hardwareAddress", deviceInfoModel.getDeviceHardwareAddress());
                editor.apply();
